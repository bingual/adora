...
const Schema: z.ZodType<Prisma.Brand_groupUpdateManyWithoutBrandNestedInput> = z
    .object({
        create: z
            .union([
...
export const Brand_groupUpdateManyWithoutBrandNestedInputObjectSchema = Schema;
