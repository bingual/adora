...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutBrandInput> =
    z
        .object({
            create: z
                .union([
...
export const ProductUncheckedCreateNestedManyWithoutBrandInputObjectSchema =
    Schema;
