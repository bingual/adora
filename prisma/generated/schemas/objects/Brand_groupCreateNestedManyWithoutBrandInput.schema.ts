...
const Schema: z.ZodType<Prisma.Brand_groupCreateNestedManyWithoutBrandInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => Brand_groupCreateWithoutBrandInputObjectSchema),
                z
                    .lazy(() => Brand_groupCreateWithoutBrandInputObjectSchema)
                    .array(),
                z.lazy(
                    () =>
        ...
        connect: z
            .union([
                ...
                z.lazy(() => Brand_groupWhereUniqueInputObjectSchema).array(),
            ])
            .optional(),
    })
    .strict();

export const Brand_groupCreateNestedManyWithoutBrandInputObjectSchema = Schema;
