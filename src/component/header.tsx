      ...
      return (
        <div className="main-tab">
          <ul>
            ...
            <li className={pathname === '/discount' ? 'on' : undefined}>
              <Link href={'/discount'}>
                <span>할인</span>
              </Link>
            </li>
            <li className={pathname === '/recommend' ? 'on' : undefined}>
              <Link href={'/recommend'}>
                <span>#PICK</span>
              </Link>
            </li>
            <li className={pathname === '/comingsoon' ? 'on' : undefined}>
            ...
            {/*    </Link>*/}
            {/*</li>*/}
            <li className={pathname === '/brand' ? 'on' : undefined}>
              <Link href={'/brand'}>
                <span>브랜드</span>
              </Link>
            </li>
