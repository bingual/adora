      ...
      <footer id={'footer'}>
        <div className="area">
          <div className="footer_left">
            ...
            <span>브랜드마다 상이함</span>
            <span>
              <Link style={{ fontWeight: 600, color: '#ff4000' }} href="#">
                여기
              </Link>
              를 참조
            </span>
        ...
        <div className="xans-element- xans-layout xans-layout-footer info">
          <span>
            ...
            <i
              ...
              className={active ? 'xi-angle-down-thin on' : 'xi-angle-down-thin'}
            ></i>
          </span>
          <br />
          {active && (
            <div>
              <span>대표자명 : 아도라</span>
              <br />
              <span className="">주소 : 1층, 2층 서울특별시 강남구 무슨로999길 99-9</span>
              <br />
              <span>통신판매업신고번호 : 제 2049-서울강남-02478 호</span>
              <br />
              <span className="">
                개인정보보호책임자 : 주식회사 아도라
                <Link href="#">(commerce@adora-shop.vercel.app)</Link>
              </span>
            </div>
          )}
          <p className="copyright">Copyright 2023 ADORA All Rights Reserved.</p>
          ...
          <p>
            고객님은 안전거래를 위해 현금 등으로 결제 시 저희 쇼핑몰에서 가입한 PG 사의
